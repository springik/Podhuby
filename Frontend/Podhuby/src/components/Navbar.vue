<template>
  <nav class="lg:mr-20 gap-y-2 lg:gap-x-3 lg:gap-y-0 navbar flex flex-col lg:flex-row my-8 place-content-center lg:justify-end lg:items-end items-center lg:flex-nowrap flex-wrap">
    ...
    <router-link v-if="userStore.user?.permision_level == 'admin'" class="border-b-2 border-tertiaryColor border-dotted text-center place-content-center text-tertiaryColor" to="/admin-dashboard">Admin Dashboard</router-link>
